...
x<-read.csv("D:\\3\\datamining\\surgery time\\sepration\\New folder\\shoulder&humerus&elbow.csv", header = TRUE,fileEncoding = "UTF-8")#"UCS-2LE")
#View(x)
y<-x
...
summary( ml_step )
#/////////////////////////////////////////////////////////////////
plot(ml_predict, actual_test,main="Shoulder surgery",
...
plot(x, test_sety, main="shoulder surgery",col = "red", type = "l")
