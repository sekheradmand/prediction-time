...
x<-read.csv("D:\\3\\datamining\\surgery time\\sepration\\New folder\\hand&wrist.csv", header = TRUE,fileEncoding = "UTF-8")#"UCS-2LE")
#View(x)
y<-x
...
summary( ml_step )
#/////////////////////////////////////////////////////////////////
plot(ml_predict, actual_test,main="hand surgery",
...
plot(pre_rpart, actual_test,main="wrisr surgery",
     xlab = "Predicted Values",
     ylab = "Observed Values")
abline(a = 0, b = 1, lwd=2,
       col = "green")
...
#mse(predYsvm,actual_test)
#Overlay SVM Predictions on Scatter Plot
#points(actual_test, predYsvm, col = "red", pch=16)
```
...
plot(x, test_sety, main="hand surgery",col = "red", type = "l")
