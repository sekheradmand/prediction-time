...
x<-read.csv("D:\\3\\datamining\\surgery time\\sepration\\New folder\\backbone&pelvic.csv", header = TRUE,fileEncoding = "UTF-8")#"UCS-2LE")
#View(x)
y<-x
...
#/////////////////////////////////////////////////
summary( ml_step )
plot(ml_predict, actual_test,main="femur surgery",
...
test_set =part_data $ part2
#head(test_set)
modelsvm = svm( anesthesia.time ~gender +data.classs +surgeon+k.anesthesia+ anesthesia+age+ k.s+surgery.code, data = y)
...
plot(x, test_sety,main="spine surgery" ,col = "red", type = "l")
