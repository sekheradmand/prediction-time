...
x<-read.csv("D:\\3\\datamining\\surgery time\\sepration\\New folder\\femur.csv", header = TRUE,fileEncoding = "UTF-8")#"UCS-2LE")
#View(x)
y<-x
...
plot(x, test_sety,main="femur surgery", col = "red", type = "l")
