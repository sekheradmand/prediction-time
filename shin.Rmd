...
x<-read.csv("D:\\3\\datamining\\surgery time\\sepration\\New folder\\shin.csv", header = TRUE,fileEncoding = "UTF-8")#"UCS-2LE")
#View(x)
y<-x
...
summary( ml_step )
#/////////////////////////////////////////////////////////////////
plot(ml_predict, actual_test,main="leg surgery",
...
plot(x, test_sety, main="leg surgery",col = "red", type = "l")
