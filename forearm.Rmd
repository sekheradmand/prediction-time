...
x<-read.csv("D:\\3\\datamining\\surgery time\\sepration\\New folder\\forearm.csv", header = TRUE,fileEncoding = "UTF-8")#"UCS-2LE")
#View(x)
y<-x
...
summary( ml_step )
#/////////////////////////////////////////////////////////////////
plot(ml_predict, actual_test,main="forearm surgery",
...
plot(x, test_sety, main="forearm surgery",col = "red", type = "l")
