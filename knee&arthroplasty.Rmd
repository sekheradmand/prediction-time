...
x<-read.csv("D:\\3\\datamining\\surgery time\\sepration\\New folder\\knee&arthroplasty.csv", header = TRUE,fileEncoding = "UTF-8")#"UCS-2LE")
#View(x)
y<-x
...
summary( ml_step )
#/////////////////////////////////////////////////////////////////
plot(ml_predict, actual_test,main="knee surgery",
...
#mse = mean((test_set - pred_y)^2)
#mae = caret::MAE(test_set, pred_y)
#rmse = caret::RMSE(test_set, pred_y)

x = 1:length(test_sety)
plot(x, test_sety, main="knee surgery",col = "red", type = "l")
